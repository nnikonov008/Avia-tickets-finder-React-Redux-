...
export const Header = ({carrier, price}) => (
  <div className={classes.header}>
    <div className={classes.carrier}>
      <img
        //Оставил затею с поиском уникальных логотипов
        //идея в том чтобы было чтото похожее на ${carrier.airlineCode}.jpg
        src={`https://all-t-shirts.ru/goods_images/ru134403II000b8f589708d9e850a6b7985281c5fd724.jpg`}
